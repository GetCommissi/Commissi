...
export default function NewLeadPage() {
  ...
  const validateForm = () => {
    ...
    // Scenario B: Handmatig nieuwe lead - minimum Bedrijfsnaam OF Contactpersoon + Telefoonnummer
    if (!formData.companyName.trim() && !formData.contactName.trim()) {
      newErrors.companyName = 'Bedrijfsnaam of Contactpersoon is verplicht';
      newErrors.contactName = 'Contactpersoon of Bedrijfsnaam is verplicht';
    }
      ...
      <PremiumLayout user={{ name: 'Lenny De K.' }}>
        <div className="flex items-center justify-center h-[60vh]">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Lead Aangemaakt!</h2>
            <p className="text-gray-500 dark:text-gray-400">Je wordt doorgestuurd naar de leads pagina...</p>
          </div>
        </div>
      </PremiumLayout>
    );
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-200 dark:border-slate-700 overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Bedrijfsnaam <span className="text-gray-400 text-xs">(of Contactpersoon)</span>
                </label>
                <input
                  type="text"
                  ...
                  className={`w-full px-4 py-3 bg-gray-50 dark:bg-slate-900 border rounded-lg focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 dark:text-white ${
                    errors.companyName ? 'border-red-500 focus:border-red-500' : 'border-gray-200 dark:border-slate-600'
                  }`}
                />
                {errors.companyName && (
          ...
          <div className="p-6 border-b border-gray-200 dark:border-slate-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Naam contactpersoon <span className="text-gray-400 text-xs">(of Bedrijfsnaam)</span>
                </label>
                <input
                  type="text"
                  ...
                  className={`w-full px-4 py-3 bg-gray-50 dark:bg-slate-900 border rounded-lg focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 dark:text-white ${
                    errors.contactName ? 'border-red-500 focus:border-red-500' : 'border-gray-200 dark:border-slate-600'
                  }`}
                />
                {errors.contactName && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 bg-gray-50 dark:bg-slate-900 border rounded-lg focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 dark:text-white ${
                      errors.phone ? 'border-red-500 focus:border-red-500' : 'border-gray-200 dark:border-slate-600'
                    }`}
                  />
                </div>
                {errors.phone && (
