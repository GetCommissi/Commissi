...
export default function AppointmentsPage() {
  ...
  const [editingAppointment, setEditingAppointment] = useState<typeof MOCK_APPOINTMENTS[0] | null>(null);
  ...
  const openEditModal = (appointment: typeof MOCK_APPOINTMENTS[0]) => {
  ...
  return (
    <PremiumLayout user={{ name: 'Lenny De K.' }}>
      ...
      {showEditModal && editingAppointment && (
        <div className="modal-overlay is-open" onClick={() => setShowEditModal(false)}>
          <div className="modal modal--md" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3 className="modal-title">Afspraak Bewerken</h3>
            ...
            <form onSubmit={saveEdit} className="modal-body">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="Adres of Zoom link"
                  className="form-input"
                />
              </div>
      ...
      {showDeleteConfirm && (
        <div className="modal-overlay is-open" onClick={() => setShowDeleteConfirm(false)}>
          <div className="modal modal--sm" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3 className="modal-title">Afspraak Verwijderen</h3>
